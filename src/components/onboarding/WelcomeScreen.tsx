  ...
  return (
    <div className="min-h-screen flex flex-col bg-luxe-dark text-white overflow-hidden">
      <div 
        ...
        style={{ 
          backgroundImage: 'linear-gradient(rgba(26, 31, 44, 0.7), rgba(26, 31, 44, 0.8)), url(https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1440&q=80)' 
        }}
      >
