...
const MembershipPage = () => {
  ...
  // If user has a membership and lands on this page, we can optionally redirect them
  // This is commented out to allow viewing the membership page even with active membership
  // But you can uncomment it if you want to force redirect
  /*
  useEffect(() => {
    if (hasMembership) {
      navigate('/dashboard');
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-serif font-semibold mb-4 text-luxe-dark">
            {hasMembership 
              ? 'Your Dominic Luxury Membership' 
              : 'Join Dominic Exclusive Membership'}
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            {hasMembership
              ? `Welcome back, ${user?.email}. Your luxury concierge services are active and ready for your requests.`
